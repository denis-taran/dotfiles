...
if current_day < 15:
    print("Generating report for the previous month.")
    ...
    print("Generating report for the current month.")
...
print(f"Fetching data from Clockify for period: {start_utc} to {end_utc}...")
